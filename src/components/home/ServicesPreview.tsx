      ...
      <div className="mx-auto max-w-[1180px] px-4">
        <Reveal>
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
            From intelligent automation to secure platforms, AINZA builds technology that solves
            practical business problems and keeps improving after launch.
          </p>
        </Reveal>
            ...
            <div className="service-command-panel relative aspect-[5/5] overflow-hidden rounded-3xl border border-white/10 bg-black/40 md:aspect-[6/5]">
                    ...
                    >
                      <span
                        className={[
                          ...
                          isActive
                            ? "bg-violet shadow-[0_0_10px_rgba(187,165,255,0.9)]"
                            : "bg-white/40",
                        ].join(" ")}
                      />
                      {s.short}
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between rounded-2xl glass px-4 py-3">
                <div className="flex items-center gap-3">
                  <ServiceIconVisual id={current.visual} decorative className="h-12 w-12" />
                  <div>
                  ...
                  <li key={s.id}>
                    ...
                    >
                      <ServiceIconVisual
                        ...
                        decorative
                        className={[
                          "mt-0.5 h-14 w-14 shrink-0 transition-all duration-300",
                          isActive ? "opacity-100" : "opacity-70 group-hover:opacity-95",
                        ].join(" ")}
                      />
